...
namespace UnityGLTF
{
    class StandardMap : IUniformMap
    {
        ...
        private static int _normalMapID = Shader.PropertyToID("_BumpMap");
        private static int _occlusionMapID = Shader.PropertyToID("_OcclusionMap");
        private static int _emissionMapID = Shader.PropertyToID("_EmissionMap");
        ...
        {
            get { return _material.HasProperty(_normalMapID) ? _material.GetTexture(_normalMapID) : null; }
            set
            {
                if (_material.HasProperty(_normalMapID))
                {
                    _material.SetTexture(_normalMapID, value);
        ...
        public virtual int NormalTextureID
        {
            get { return _normalMapID; }
        }
        ...
        {
            get { return _material.HasProperty(_occlusionMapID) ? _material.GetTexture(_occlusionMapID) : null; }
            set
            {
                if (_material.HasProperty(_occlusionMapID))
                {
                    _material.SetTexture(_occlusionMapID, value);
                }
                else
                {
        ...
        public virtual int OcclusionTextureID
        {
            get { return _occlusionMapID; }
        }
        ...
        {
            get { return _material.HasProperty(_emissionMapID) ? _material.GetTexture(_emissionMapID) : null; }
            set
            {
                if (_material.HasProperty(_emissionMapID))
                {
                    _material.SetTexture(_emissionMapID, value);
        ...
        public virtual int EmissiveTextureID
        {
            get { return _emissionMapID; }
        }
